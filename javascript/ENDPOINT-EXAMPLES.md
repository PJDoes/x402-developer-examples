...
```javascript
const response = await client.post('/v1/llm/gpt-5-mini', {
  messages: [
...
```javascript
const response = await client.post('/v1/llm/claude-4.5', {
  messages: [
...
```javascript
const response = await client.post('/v1/llm/grok-4', {
  messages: [
...
```javascript
const response = await client.post('/v1/llm/grok-fast', {
  messages: [
...
```javascript
const response = await client.post('/v1/llm/gemini-2.5', {
  messages: [
...
```javascript
const response = await client.post('/v1/openai/images/edit', {
...
```javascript
const response = await client.post('/v1/openai/ticker-to-image', {
  ticker: 'TOSHI',
...
```javascript
const response = await client.post('/v1/nanobanana/generate', {
...
```javascript
const response = await client.post('/v1/nanobanana/edit', {
...
```javascript
const response = await client.post('/v1/sora/image-to-video', {
...
```javascript
const response = await client.post('/v1/sora-pro/generate', {
...
```javascript
const response = await client.post('/v1/veo3/fast/image-to-video', {
...
```javascript
const response = await client.post('/v1/veo3/generate', {
...
```javascript
const response = await client.post('/v1/veo3.1/fast/generate', {
...
```javascript
const response = await client.post('/v1/veo3.1/generate', {
...
```javascript
const response = await client.post('/v1/veo3.1/reference-to-video', {
...
async function callLLM(model, prompt, options = {}) {
  const response = await client.post(`/v1/llm/${model}`, {
